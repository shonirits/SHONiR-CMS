...
<li class="list-group-item bg-dark">
  <a class="text-white text-decoration-none d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#menublogs" role="button" aria-expanded="false" aria-controls="menublogs">
    <span><i class="fa-solid fa-ellipsis-vertical"></i> Blogs</span>
    <i class="fa-solid fa-chevron-down small transition" aria-hidden="true"></i>
  </a>
  <div class="collapse ps-3 pt-2" id="menublogs" data-bs-parent="#sidebarMenu">
    <ul class="list-unstyled">
      <li><a class="text-white text-decoration-none d-block py-1 small" href="<?php echo $cc['base_url'].'Blogs/categories_list'; ?>"><i class="fa-solid fa-ellipsis"></i> Categories List</a></li>
      <li><a class="text-white text-decoration-none d-block py-1 small" href="<?php echo $cc['base_url'].'Blogs/categories_add'; ?>"><i class="fa-solid fa-ellipsis"></i> Add Category</a></li>
      <li><a class="text-white text-decoration-none d-block py-1 small" href="<?php echo $cc['base_url'].'Blogs/posts_list'; ?>"><i class="fa-solid fa-ellipsis"></i> Post List</a></li>
      <li><a class="text-white text-decoration-none d-block py-1 small" href="<?php echo $cc['base_url'].'Blogs/posts_add'; ?>"><i class="fa-solid fa-ellipsis"></i> Add Post</a></li>
    </ul>
  </div>
</li>
...
<li class="list-group-item bg-dark">
  <a class="text-white text-decoration-none d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#menugalleries" role="button" aria-expanded="false" aria-controls="menugalleries">
    <span><i class="fa-solid fa-ellipsis-vertical"></i> Galleries</span>
    <i class="fa-solid fa-chevron-down small transition" aria-hidden="true"></i>
  </a>
  <div class="collapse ps-3 pt-2" id="menugalleries" data-bs-parent="#sidebarMenu">
    <ul class="list-unstyled">
      <li><a class="text-white text-decoration-none d-block py-1 small" href="<?php echo $cc['base_url'].'Galleries/list'; ?>"><i class="fa-solid fa-ellipsis"></i> List</a></li>
      <li><a class="text-white text-decoration-none d-block py-1 small" href="<?php echo $cc['base_url'].'Galleries/add'; ?>"><i class="fa-solid fa-ellipsis"></i> Add</a></li>
    </ul>
  </div>
</li>
