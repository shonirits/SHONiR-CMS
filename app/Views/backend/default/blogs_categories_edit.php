<?php echo view('backend/'.$cc['backend_theme'].'/common/page_start'); ?>
  ...
  <form name="edit_frm" id="edit_frm" action="<?php echo $cc['base_url'].'Blogs/categories_edit?id='.$form['id']; ?>" method="POST" role="form" enctype='multipart/form-data' novalidate>
  ...
  <input type="hidden" name="token" id="token" value="<?php echo $form['token']; ?>">
          ...
          <h1>Blogs<h1>
           ...
           <div class="col-8 p-3">
           <h2>Edit Category: <?php echo $form['id']; ?><h2>
           </div>
           <div class="col-4 p-3">
