  ...
  <div class="container">
          ...
          <?php  foreach ($pagination['result'] as $row)
            ...
            <tr>
              ...
              <td class="text-center align-middle"><a href="<?php echo $cc['base_url'].'Pages/edit?id='.$row['page_id']; ?>" data-bs-toggle="tooltip" data-bs-original-title="Edit" title="Edit" ><i class="fa-solid fa-pen-to-square"></i></a> <a href="javascript:confirm_fnc('Cancel', '', '', 'Delete', '<?php echo $cc['base_url'].'Pages/delete?id='.$row['page_id']; ?>', '', 'Delete Record ID# <?php echo $row['page_id']; ?>', 'Are you sure you want to delete record id# <b><?php echo $row['page_id']; ?></b>, title: <b><?php echo html2text_fnc($row['title']); ?></b>?');" data-bs-toggle="tooltip" data-bs-original-title="Delete" title="Delete" ><i class="fa-solid fa-trash-can"></i></a></td>
            </tr>
            <?php } ?>
          </tbody>
          </table>
