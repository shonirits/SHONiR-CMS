<?php echo view('backend/'.$cc['backend_theme'].'/common/page_start'); ?>
  ...
  <form name="edit_frm" id="edit_frm" action="<?php echo $cc['base_url'].'Configurations'; ?>" method="POST" role="form" enctype='multipart/form-data' novalidate>
          ...
          <input type="text" id="img_url" name="img_url" value="<?php echo $form['base_url']; ?>" class="form-control" aria-describedby="img_urlhelpblock" minlength="2"  required>
          <div class="invalid-feedback">  
          Required valid information. 
          </div>
          ...
          <div id="app_emailhelpblock" class="form-text">
            Business email for support or inquiries. Must be a valid format (e.g., excompk@ex.com.pk).
          </div>
          </div>
          ...
          <div id="app_websitehelpblock" class="form-text">
            Enter your company’s website without http:// or https:// (e.g., ex.com.pk).
          </div>
          </div>
          ...
          <div id="social_instagramhelpblock" class="form-text">
            https://www.instagram.com/excompk/
          </div>
          </div>
          ...
          <div id="social_pinteresthelpblock" class="form-text">
            https://www.pinterest.com/excompk/
          </div>
          </div>
          ...
          <div id="social_linkedinhelpblock" class="form-text">
           https://www.linkedin.com/company/excompk/
          </div>
          </div>
          ...
          <div id="social_grouphelpblock" class="form-text">
            https://groups.google.com/g/excompk
          </div>
          </div>
          ...
          <div id="social_reddithelpblock" class="form-text">
            https://www.reddit.com/user/excompk/
          </div>
          </div>
          ...
          <div id="social_maphelpblock" class="form-text">
            https://www.google.com/maps/place/ExTech+Corporation/@32.4967665,74.4916488,17z/
          </div>
          </div>
  ...
  <div class="card-body">
    <div class="row g-3">
      ...
      <div class="col-md-6">
       ...
       <div class="col-md-6">
        <div class="form-check form-switch">
          <input class="form-check-input" type="checkbox" id="badge_hd" name="badge_hd" value="TRUE" <?php echo ($form['badge_hd'] == 'TRUE') ? 'checked' : ''; ?>>
          <label class="form-check-label" for="badge_hd">High Definition</label>
        </div>
      </div>

       <div class="col-md-6">
        <div class="form-check form-switch">
          <input class="form-check-input" type="checkbox" id="badge_lq" name="badge_lq" value="TRUE" <?php echo ($form['badge_lq'] == 'TRUE') ? 'checked' : ''; ?>>
          <label class="form-check-label" for="badge_lq">Low Quality</label>
        </div>
      </div>

       <div class="col-md-6">
        <div class="form-check form-switch">
          <input class="form-check-input" type="checkbox" id="badge_st" name="badge_st" value="TRUE" <?php echo ($form['badge_st'] == 'TRUE') ? 'checked' : ''; ?>>
          <label class="form-check-label" for="badge_st">Subtitle</label>
        </div>
      </div>
