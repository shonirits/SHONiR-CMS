<?php echo view('backend/'.$cc['backend_theme'].'/common/page_start'); ?>
  ...
  <input type="hidden" name="token" id="token" value="<?php echo $form['token']; ?>">
          ...
          <option value="0" <?php echo ($form['awards'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          if($form['db_awards']){
          ...
          <option value="0" <?php echo ($form['industries'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          ...
          <option value="0" <?php echo ($form['regions'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          if($form['db_regions']){
          ...
          <option value="0" <?php echo ($form['voices'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          if($form['db_voices']){
          ...
          <option value="0" <?php echo ($form['natives'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          if($form['db_natives']){
          ...
          <option value="0" <?php echo ($form['places'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          if($form['db_places']){
          ...
          <option value="0" <?php echo ($form['actors'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          if($form['db_actors']){
          ...
          <option value="0" <?php echo ($form['actresses'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          ...
          <option value="0" <?php echo ($form['directors'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          ...
          <option value="0" <?php echo ($form['producers'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          ...
          <option value="0" <?php echo ($form['writers'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          if($form['db_writers']){
          ...
          <option value="0" <?php echo ($form['singers'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          if($form['db_singers']){
          ...
          <option value="0" <?php echo ($form['designers'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          ...
          <option value="0" <?php echo ($form['editors'])?'':'selected="selected" selected'; ?>>---None---</option>
          <?php 
          if($form['db_editors']){
         ...
         <option value="0" <?php echo ($form['cinematographers'])?'':'selected="selected" selected'; ?>>---None---</option>
         <?php 
