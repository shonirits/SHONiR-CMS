...
<script src="<?php echo $cc['js_url'].'public/js/backend/default.js?'.time(); ?>"></script>
<script data-src="<?php echo $cc['js_url'].'public/js/backend/'.$cc['backend_theme'].'/theme.js?'.time(); ?>"></script>