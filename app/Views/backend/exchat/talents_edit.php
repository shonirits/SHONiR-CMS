<?php echo view('backend/'.$cc['backend_theme'].'/common/page_start'); ?>
  ...
  <form name="edit_frm" id="edit_frm" action="<?php echo $cc['base_url'].'Talents/edit?id='.$form['id']; ?>" method="POST" role="form" enctype='multipart/form-data' novalidate>
          ...
          <select class="form-control" id="type_id" name="type_id" required>
              ...
              if (!empty($form['type_list'])) {
                  foreach ($form['type_list'] as $id => $name) { ?>
                      ...
                      <?php echo (!empty($form['type_id']) && in_array($id, (array)$form['type_id'])) ? 'selected="selected"' : ''; ?>>
