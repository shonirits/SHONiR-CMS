...
"><i class="fa-solid fa-pen-to-square"></i></a> <a href="javascript:confirm_fnc('Cancel', '', '', 'Delete', '<?php echo $cc['base_url'].'Banners/delete?id='.$row['banner_id']; ?>', '', 'Delete Record ID# <?php echo $row['banner_id']; ?>', 'Are you sure you want to delete record id# <b><?php echo $row['banner_id']; ?></b>, title: <b><?php echo html2text_fnc($row['title']); ?></b>?');"  data-bs-toggle="tooltip" data-bs-original-title="Delete" title="Delete
