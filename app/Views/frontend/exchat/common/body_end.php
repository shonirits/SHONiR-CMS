...
<script src="<?php echo $cc['js_url'].'public/js/frontend/default.js?'.time(); ?>"></script>
<script data-src="<?php echo $cc['js_url'].'public/js/frontend/'.$cc['frontend_theme'].'/theme.js?'.time(); ?>"></script>