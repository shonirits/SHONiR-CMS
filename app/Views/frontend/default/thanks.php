...
<section class="container-fluid cart">
  ...
  <div class="card-body">
    ...
    <ul class="list-group list-group-flush mb-3">
      ...
      <li class="list-group-item">
        <strong>Bulk & Custom Orders:</strong> A personalized timeline will be outlined in your quotation and managed with support from our cargo agent <a href="https://www.decentcc.com" rel="follow" data-bs-toggle="tooltip" data-bs-original-title="Decent Cargo & Courier" title="Decent Cargo & Courier"><strong>Decent Cargo & Courier</strong></a>.
      </li>
    </ul>
