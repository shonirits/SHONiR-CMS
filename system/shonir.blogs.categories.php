...
function SHONiR_Blogs_Category_Href_Fnc($SHONiR_ID, $SHONiR_Slug = "None", $SHONiR_Mode = "Basic"){
...
if(SHONiR_SETTINGS['config_sef'] == "TRUE"){
    ...
    $SHONiR_Data = SHONiR_BASE.'Blogs/'.$SHONiR_ID.'_'.$SHONiR_Slug;

    }else{

        $SHONiR_Data = SHONiR_BASE.'Ajax/Blogs-Quick-View/'.$SHONiR_ID.'_'.$SHONiR_Slug;
...
function SHONiR_Blogs_Categories_Menu_Fnc($SHONiR_Array, $SHONiR_Level=1, $SHONiR_Class=TRUE){
    ...
    foreach ($SHONiR_Array as $Array_key => $Array_value)
    {
        ...
        if(isset($Array_value['child'])){
            ...
            $SHONiR_Data .= '<a id="dropdownMenu'.$SHONiR_Level.'" href="'.SHONiR_Blogs_Category_Href_Fnc($Array_value['category_id'], $Array_value['slug']).'" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="'.$SHONiR_Href_Class.' dropdown-toggle">'.$Array_value['name'].'</a>';
            $SHONiR_Data .= '<ul aria-labelledby="dropdownMenu'.$SHONiR_Level.'" class="dropdown-menu border-0 shadow">';
            $SHONiR_Data .= SHONiR_Blogs_Categories_Menu_Fnc($Array_value['child'], $SHONiR_Level);
            $SHONiR_Data .= '</li>';
            $SHONiR_Data .= '</ul>';
            ...
            $SHONiR_Data .= '<li class="'.$SHONiR_LI_Class.'"><a href="'.SHONiR_Blogs_Category_Href_Fnc($Array_value['category_id'], $Array_value['slug']).'" class="'.$SHONiR_Href_Class.'">'.$Array_value['name'].'</a></li>';
...
function SHONiR_Blogs_Categories_Tree_Fnc($SHONiR_ID =  0, $SHONiR_Where = '', $SHONiR_Language_ID){
    ...
    if($SHONiR_ID){        
        ...
        $SHONiR_Query_Categories = SHONiR_Query_Fnc("select c.category_id from tbl_blogs_categories c left join tbl_blogs_categories_to_categories ctc on c.category_id=ctc.category_id where ".$SHONiR_Extra." ctc.parent_id=".$SHONiR_ID." order by c.sort_order asc;");

    }else{

        $SHONiR_Query_Categories = SHONiR_Query_Fnc("select c.category_id from tbl_blogs_categories c left join tbl_blogs_categories_to_categories ctc on c.category_id=ctc.category_id where  ".$SHONiR_Extra."  ctc.category_id is null order by c.sort_order asc;");
...
{        
        ...
        if(SHONiR_Blogs_Has_Sub_Fnc($row['category_id'])){

            $SHONiR_Child['child'] = SHONiR_Blogs_Categories_Tree_Fnc($row['category_id'], $SHONiR_Where, $SHONiR_Language_ID);            
            $SHONiR_Parent = SHONiR_Blogs_Category_Details_Fnc($row['category_id'], '', $SHONiR_Language_ID);
...
function SHONiR_Blogs_Has_Sub_Fnc($SHONiR_ID){

    $SHONiR_Query_Categories = SHONiR_Query_Fnc("select c.category_id from tbl_blogs_categories c left join tbl_blogs_categories_to_categories ctc on c.category_id=ctc.parent_id where ctc.parent_id=".$SHONiR_ID);

    return SHONiR_Row_Fnc($SHONiR_Query_Categories);

}

function SHONiR_Blogs_Category_Details_Fnc($SHONiR_ID, $SHONiR_Where, $SHONiR_Language_ID){
    ...
    $SHONiR_Get_Category = SHONiR_Get_Blogs_Category_Fnc($SHONiR_ID, $SHONiR_Where);
     ...
     $SHONiR_Get_Category_Description = SHONiR_Blogs_Category_Description_Fnc($SHONiR_ID, $SHONiR_Language_ID);

     $SHONiR_Category_Uploads = SHONiR_Uploads_Fnc($SHONiR_ID, 'blogs_category');
     ...
     if($SHONiR_Category_Uploads){
      ...
      $SHONiR_Data['href'] =  SHONiR_Blogs_Category_Href_Fnc($SHONiR_ID, $SHONiR_Get_Category_Description['slug']);

      $SHONiR_Data['qhref'] =  SHONiR_Blogs_Category_Href_Fnc($SHONiR_ID, $SHONiR_Get_Category_Description['slug'], 'Quick');
...
function SHONiR_Get_Blogs_Category_Fnc($SHONiR_ID =  null, $SHONiR_Where = null){
    ...
    if($SHONiR_ID ){
        ...
        $SHONiR_Query_Category = SHONiR_Query_Fnc("select * from tbl_blogs_categories where category_id=".$SHONiR_ID ."");
...
function SHONiR_Blogs_Category_Description_Fnc($SHONiR_ID, $SHONiR_Language_ID){

    $SHONiR_Query_Category_Extra = " and language_id=".$SHONiR_Language_ID;

    $SHONiR_Query_Category_description = SHONiR_Query_Fnc("select * from tbl_blogs_categories_description where category_id=".$SHONiR_ID." ".$SHONiR_Query_Category_Extra);
...
function SHONiR_Blogs_Category_Parents_Fnc($SHONiR_ID){

    $SHONiR_Query_Category_Parents = SHONiR_Query_Fnc("select * from tbl_blogs_categories_to_categories where category_id=".$SHONiR_ID);
...
function SHONiR_AP_Blogs_Categories_Fnc_Render(){
   ...
   SHONiR_Query_Fnc("insert into tbl_blogs_categories (sort_order, status, listed, locked, featured, add_time, edit_time) values (".$SHONiR_sort_order.", ".$SHONiR_status.", ".$SHONiR_listed.", ".$SHONiR_locked.", ".$SHONiR_featured.", ".time().", ".time()." )");
...
if($SHONiR_parent){
    ...
    foreach ($SHONiR_parent as $parent){
        ...
        if($parent > 0 ){
            ...
            SHONiR_Query_Fnc("insert into tbl_blogs_categories_to_categories (category_id, parent_id) values (".$SHONiR_category_id.", ".$parent.")");
...
SHONiR_Query_Fnc("insert into tbl_uploads (upload_file, sort_order, parent_id, parent_type, add_time) values ('".$SHONiR_files_final."', ".$SHONiR_sort_order.", ".$SHONiR_category_id.", 'blogs_category', ".time().")");
...
move_uploaded_file($SHONiR_files["tmp_name"][$i], SHONiR_ROOT.'media/uploads/'.$SHONiR_files_final);
 ...
 SHONiR_Redirect_Fnc(SHONiR_APANEL.'Blogs_Categories');
    ...
    $SHONiR_Get_category_id = SHONiR_Get_Fnc('category_id');
        ...
        SHONiR_Redirect_Fnc(SHONiR_APANEL.'Blogs_Categories');
           ...
           $SHONiR_Get_Category_Records = SHONiR_Get_Blogs_Category_Fnc($SHONiR_Get_category_id);
           ...
           SHONiR_Query_Fnc("delete from tbl_blogs_categories_to_categories where category_id=".$SHONiR_Get_category_id);
    ...
    $SHONiR_sort_order = SHONiR_Post_Fnc('sort_order', FILTER_VALIDATE_INT);
     ...
     SHONiR_Query_Fnc("update tbl_blogs_categories set sort_order=". $SHONiR_sort_order .", status=". $SHONiR_status .", listed=". $SHONiR_listed .", locked=". $SHONiR_locked .", featured=". $SHONiR_featured .", edit_time =". time() ." where category_id=".$SHONiR_Get_category_id);
        ...
        foreach($SHONiR_All_Languages as $language)
{
    ...
    if(SHONiR_Blogs_Category_Description_Fnc($SHONiR_Get_category_id, $language['language_id'])){


SHONiR_Query_Fnc("update tbl_blogs_categories_description set slug='".SHONiR_Slug_Fnc(SHONiR_Post_Fnc('slug_'.$language['language_id']))."',  name='".SHONiR_Post_Fnc('name_'.$language['language_id'])."',  description='".SHONiR_Post_Fnc('description_'.$language['language_id'])."',  meta_title='".SHONiR_Post_Fnc('meta_title_'.$language['language_id'])."',  meta_description='".SHONiR_Post_Fnc('meta_description_'.$language['language_id'])."',  meta_keyword='".SHONiR_Post_Fnc('meta_keyword_'.$language['language_id'])."'  where language_id=".$language['language_id']." and category_id=".$SHONiR_Get_category_id);

    }else{

        SHONiR_Query_Fnc("insert into tbl_blogs_categories_description (category_id, language_id, slug, name, description, meta_title, meta_description, meta_keyword) values (".$SHONiR_Get_category_id.", ".$language['language_id'].", '".SHONiR_Slug_Fnc(SHONiR_Post_Fnc('slug_'.$language['language_id']))."', '".SHONiR_Post_Fnc('name_'.$language['language_id'])."', '".SHONiR_Post_Fnc('description_'.$language['language_id'])."', '".SHONiR_Post_Fnc('meta_title_'.$language['language_id'])."', '".SHONiR_Post_Fnc('meta_description_'.$language['language_id'])."', '".SHONiR_Post_Fnc('meta_keyword_'.$language['language_id'])."')");
...
if($SHONiR_parent){
    ...
    foreach ($SHONiR_parent as $parent){
        ...
        if($parent > 0 ){
            ...
            SHONiR_Query_Fnc("insert into tbl_blogs_categories_to_categories (category_id, parent_id) values (".$SHONiR_Get_category_id.", ".$parent.")");
...
$SHONiR_Uploads_Records = SHONiR_Uploads_Fnc($SHONiR_Get_category_id, 'blogs_category');
...
SHONiR_Query_Fnc("insert into tbl_uploads (upload_file, sort_order, parent_id, parent_type, add_time) values ('".$SHONiR_files_final."', ".$SHONiR_sort_order.", ".$SHONiR_Get_category_id.", 'blogs_category', ".time().")");
...
$SHONiR_Alert['type'] = 'success';
 ...
 SHONiR_Redirect_Fnc(SHONiR_APANEL.'Blogs_Categories');
        ...
        if($SHONiR_Second == 'Add'){           
            ...
            $SHONiR_Main['meta_title'] = 'Add | Blogs Categories | SHONiR Administrator Panel | Created with LOVE by SHONiR';
            ...
            $GLOBALS['SHONiR_VIEWS_FILE'] = "blogs-categories-add";
    ...
    $SHONiR_Main[$Category_key] = $Category_value;
            ...
            foreach ($SHONiR_Languages_Records as $Languages_value)
            {
                ...
                $SHONiR_Category_Description_Records[$Languages_value['language_id']] = SHONiR_Blogs_Category_Description_Fnc($SHONiR_Get_category_id, $Languages_value['language_id']);
            ...
            if(SHONiR_Post_Fnc('SHONiR_CSRF')){
                ...
                $SHONiR_Main['SHONiR_Parent'] = SHONiR_Blogs_Category_Parents_Fnc($SHONiR_Get_category_id);

            }

            $SHONiR_Main['meta_title'] = 'Edit | Blogs Categories | SHONiR Administrator Panel | Created with LOVE by SHONiR';
            ...
            $GLOBALS['SHONiR_VIEWS_FILE'] = "blogs-categories-edit";
         ...
         SHONiR_Redirect_Fnc(SHONiR_APANEL.'Blogs_Categories');
            ...
            SHONiR_Redirect_Fnc(SHONiR_APANEL.'Blogs_Categories');
             ...
             if (file_exists(SHONiR_ROOT.'media/uploads/'.$Uploads_value['upload_file'])) { unlink (SHONiR_ROOT.'media/uploads/'.$Uploads_value['upload_file']); } 
               ...
               SHONiR_Query_Fnc("delete from tbl_blogs_categories_description where category_id=".$SHONiR_Get_category_id);

               SHONiR_Query_Fnc("delete from tbl_blogs_categories where category_id=".$SHONiR_Get_category_id);
 ...
 SHONiR_Redirect_Fnc(SHONiR_APANEL.'Blogs_Categories');
            ...
            $SHONiR_Main['meta_title'] = 'Blogs Categories | SHONiR Administrator Panel | Created with LOVE by SHONiR';

            $SHONiR_Main['meta_description'] = '';
            
            $SHONiR_Main['meta_keyword'] = '';

           $SHONiR_Main['SHONiR_Get_Categories'] = SHONiR_Get_Blogs_Categories_Fnc();
...
function SHONiR_Get_Blogs_Categories_Fnc($SHONiR_Parent = 0, $SHONiR_Where = FALSE, $SHONiR_Order = 'c.sort_order', $SHONiR_By = 'asc', $SHONiR_Limit = FALSE){
    ...
    if($SHONiR_Parent){
        ...
        $SHONiR_SQL_Categories = "select * from tbl_blogs_categories c left join tbl_blogs_categories_to_categories ctc on c.category_id=ctc.category_id ";
    ...
    $SHONiR_SQL_Categories = "select * from tbl_blogs_categories c" ;
        ...
        while($row =  SHONiR_Fetch_Fnc($SHONiR_Query_Categories))
{
    ...
    $SHONiR_Category_description = SHONiR_Blogs_Category_Description_Fnc($row['category_id'], SHONiR_LANGUAGE['language_id']);

    $SHONiR_Category_Uploads = SHONiR_Uploads_Fnc($row['category_id'], 'blogs_category');
    ...
    $SHONiR_More['href'] =  SHONiR_Blogs_Category_Href_Fnc($row['category_id'], $SHONiR_Category_description['slug']);

     $SHONiR_More['qhref'] =  SHONiR_Blogs_Category_Href_Fnc($row['category_id'], $SHONiR_Category_description['slug'], 'Quick');

        $SHONiR_Data[] = array_merge($row,$SHONiR_Category_description,$SHONiR_More);

    }else{

        $SHONiR_More['href'] =  SHONiR_Blogs_Category_Href_Fnc($row['category_id'], 'Empty');

     $SHONiR_More['qhref'] =  SHONiR_Blogs_Category_Href_Fnc($row['category_id'], 'Empty', 'Quick');
