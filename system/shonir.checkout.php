...
function SHONiR_Checkout_Fnc_Render(){
    ...
    $SHONiR_Main = SHONiR_Page_Details_Fnc(12, ' and p.status=1 ', SHONiR_LANGUAGE['language_id']);  
    ...
    if(SHONiR_SETTINGS['guest_order']==='FALSE' && SHONiR_USER['user_type']===0){

        SHONiR_Redirect_Fnc(SHONiR_BASE.'Customers/Login?continue='.urlencode(SHONiR_LINK));   
    ...
    if($SHONiR_CSRF){     
        ...
        if(SHONiR_CSRF_Fnc($SHONiR_CSRF)){
            ...
            if(SHONiR_Captcha_Fnc_Render($SHONiR_Captcha)){     
                ...
                SHONiR_New_Order_Fnc($SHONiR_Main['SHONiR_Cart']['Products'], $SHONiR_ship_name, $SHONiR_ship_company, $SHONiR_ship_email, $SHONiR_ship_cell, $SHONiR_ship_address1, $SHONiR_ship_address2, $SHONiR_ship_postcode, $SHONiR_ship_country_id, $SHONiR_ship_region_id, $SHONiR_ship_city_id, $SHONiR_bill_name, $SHONiR_bill_company, $SHONiR_bill_email, $SHONiR_bill_cell, $SHONiR_bill_address1, $SHONiR_bill_address2, $SHONiR_bill_postcode, $SHONiR_bill_country_id, $SHONiR_bill_region_id, $SHONiR_bill_city_id, $SHONiR_shipping_method, $SHONiR_payment_method, $SHONiR_gift_cover, $SHONiR_tag_card, $SHONiR_tag_card_text, SHONiR_USER['user_id'], SHONiR_USER['user_type'], $SHONiR_user_comments, $SHONiR_contract_term, $SHONiR_freight_forwarding, SHONiR_SETTINGS['order_product_history']);
    ...
    $SHONiR_Data["Main_Banners"] = SHONiR_Get_Banners_Fnc(TRUE, TRUE, "parent_id='checkout' and b.status=1  and b.listed=1 ", 'b.viewed', 'asc');
