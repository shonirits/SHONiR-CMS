...
$SHONiR_All_Categories = $SHONiR_Main['SHONiR_Categories'];?><!doctype html>
<html lang="en">
  <head>
...
<input type="hidden" name="files_sort_order" id="files_sort_order" value="<?php echo $SHONiR_Main['files_sort_order'];?>">
 ...
 <div class="card shadow mb-4"> 
          ...
          foreach($SHONiR_All_Categories as $category){ 
            if($SHONiR_Main['SHONiR_GET_ID']!=$category['category_id']){            
            ?>
  ...
  <?php 
          ...
          <input type="text" class="form-control" id="slug_<?php echo $language['language_id']?>" name="slug_<?php echo $language['language_id']?>" placeholder="category-slug" required="" value="<?php echo $SHONiR_Main['slug_'.$language['language_id']] ?>">
          </div>
          ...
          <input type="text" class="form-control" id="name_<?php echo $language['language_id']?>" name="name_<?php echo $language['language_id']?>" placeholder="Category Name" required="" value="<?php echo $SHONiR_Main['name_'.$language['language_id']] ?>">
          </div>
...
<div class="mb-3">
          ...
          <textarea type="text" class="form-control" id="description_<?php echo $language['language_id']?>" name="description_<?php echo $language['language_id']?>" placeholder="this is a main category description." ><?php echo $SHONiR_Main['description_'.$language['language_id']] ?></textarea>
          </div>
<?php }?>
               ...
               foreach($SHONiR_All_Languages as $language)
{
          ...
          <textarea type="text" class="form-control" id="meta_description_<?php echo $language['language_id']?>" name="meta_description_<?php echo $language['language_id']?>" placeholder="this is a main category description for meta tag." required=""><?php echo $SHONiR_Main['meta_description_'.$language['language_id']] ?></textarea>
          </div>
...
<div class="mb-3">
          ...
          <textarea type="text" class="form-control" id="meta_keyword_<?php echo $language['language_id']?>" name="meta_keyword_<?php echo $language['language_id']?>" placeholder="category, categories, sub category, sub categories" required=""><?php echo $SHONiR_Main['meta_keyword_'.$language['language_id']] ?></textarea>
          </div>
          <?php }?>
