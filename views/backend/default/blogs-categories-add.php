...
<input type="hidden" name="files_sort_order" id="files_sort_order" value="">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">Blogs Categories : Add</h1>
 ...
 <div class="card shadow mb-4"> 
  ...
  <?php }}?>
          ...
          <input type="text" class="form-control" id="slug_<?php echo $language['language_id']?>" name="slug_<?php echo $language['language_id']?>" placeholder="category-slug" required="" value="<?php echo SHONiR_Post_Fnc('slug_'.$language['language_id']) ?>">
          </div>
          ...
          <input type="text" class="form-control" id="name_<?php echo $language['language_id']?>" name="name_<?php echo $language['language_id']?>" placeholder="Category Name" required="" value="<?php echo SHONiR_Post_Fnc('name_'.$language['language_id']) ?>">
          </div>
...
<div class="mb-3">
          ...
          <textarea type="text" class="form-control" id="description_<?php echo $language['language_id']?>" name="description_<?php echo $language['language_id']?>" placeholder="this is a main category description." ><?php echo SHONiR_Post_Fnc('description_'.$language['language_id']) ?></textarea>
          </div>
<?php }?>
               ...
               foreach($SHONiR_All_Languages as $language)
{
          ...
          <textarea type="text" class="form-control" id="meta_description_<?php echo $language['language_id']?>" name="meta_description_<?php echo $language['language_id']?>" placeholder="this is a main category description for meta tag." required=""><?php echo SHONiR_Post_Fnc('meta_description_'.$language['language_id']) ?></textarea>
          </div>
...
<div class="mb-3">
          ...
          <textarea type="text" class="form-control" id="meta_keyword_<?php echo $language['language_id']?>" name="meta_keyword_<?php echo $language['language_id']?>" placeholder="category, categories, sub category, sub categories" required=""><?php echo SHONiR_Post_Fnc('meta_keyword_'.$language['language_id']) ?></textarea>
          </div>
          <?php }?>
