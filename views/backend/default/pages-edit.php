...
$SHONiR_All_Pages = $SHONiR_Main['SHONiR_Pages'];?><!doctype html>
<html lang="en">
  <head>
...
<input type="hidden" name="files_sort_order" id="files_sort_order" value="<?php echo $SHONiR_Main['files_sort_order'];?>">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">Pages : Edit</h1>
 ...
 <div class="card shadow mb-4"> 
          ...
          <?php if($SHONiR_All_Pages){
          foreach($SHONiR_All_Pages as $Page){ 
            if($SHONiR_Main['SHONiR_GET_ID']!=$Page['page_id']){            
            ?>
  <option value="<?php echo $Page['page_id']?>" <?php echo @(in_array($Page['page_id'], $SHONiR_Main['SHONiR_Parent']))?'selected="selected" selected':''; ?> ><?php echo $Page['name']?></option>
  <?php 
            }
}
...
<div class="mb-3">
          ...
          <textarea type="text" class="form-control" id="meta_keyword_<?php echo $language['language_id']?>" name="meta_keyword_<?php echo $language['language_id']?>" placeholder="Page, Pages, sub Page, sub Pages" required=""><?php echo $SHONiR_Main['meta_keyword_'.$language['language_id']] ?></textarea>
          </div>
          <?php }?>
