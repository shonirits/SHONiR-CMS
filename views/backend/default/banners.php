...
<?php require_once('common/top.php');?>
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <a href="<?php echo SHONiR_APANEL.'banners/Add'; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-lg text-white-50"></i> &nbsp; Add Banner</a>
        </div>
...
if($SHONiR_Main['SHONiR_Get_Banners']){
...
?>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php foreach ($SHONiR_Main['SHONiR_Get_Banners'] as $Brand_key => $Brand_value)
            {?>
                    <tr>
                      <td><?php echo $Brand_value['parent_id'] ?></td>
                      ...
                      <td> <a href="<?php echo SHONiR_APANEL.'banners/Edit?banner_id='.$Brand_value['banner_id']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i class="fas fa-edit fa-lg text-white-50"></i></a> <a href="javascript:SHONiR_Confirm_Fnc('Delete Brand', 'Are you sure to delete this Brand?', '<?php echo SHONiR_APANEL.'banners/Delete?banner_id='.$Brand_value['banner_id']; ?>')" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i class="fas fa-trash fa-lg text-white-50"></i></a></td>
                    </tr>
<?php } ?>
                  </tbody>
                </table>
