...
$SHONiR_All_Pages = $SHONiR_Main['SHONiR_Pages']; 
 ?><!doctype html>
<html lang="en">
  <head>
...
<input type="hidden" name="files_sort_order" id="files_sort_order" value="">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">Pages : Add</h1>
 ...
 <div class="card shadow mb-4"> 
          ...
          if($SHONiR_All_Pages){
          foreach($SHONiR_All_Pages as $Page){ ?>
  <option value="<?php echo $Page['page_id']?>" <?php echo @(in_array($Page['page_id'], $SHONiR_parent))?'selected="selected" selected':''; ?> ><?php echo $Page['name']?></option>
  <?php }}?>
</select>
          </div>
          ...
          <input type="text" class="form-control" id="slug_<?php echo $language['language_id']?>" name="slug_<?php echo $language['language_id']?>" placeholder="Page-slug" required="" value="<?php echo SHONiR_Post_Fnc('slug_'.$language['language_id']) ?>">
          </div>
          ...
          <input type="text" class="form-control" id="name_<?php echo $language['language_id']?>" name="name_<?php echo $language['language_id']?>" placeholder="Page Name" required="" value="<?php echo SHONiR_Post_Fnc('name_'.$language['language_id']) ?>">
          </div>
...
<div class="mb-3">
          ...
          <textarea type="text" class="form-control" id="description_<?php echo $language['language_id']?>" name="description_<?php echo $language['language_id']?>" placeholder="this is a main Page description." ><?php echo SHONiR_Post_Fnc('description_'.$language['language_id']) ?></textarea>
          </div>
<?php }?>
...
<div class="mb-3">
          ...
          <textarea type="text" class="form-control" id="meta_keyword_<?php echo $language['language_id']?>" name="meta_keyword_<?php echo $language['language_id']?>" placeholder="Page, Pages, sub Page, sub Pages" required=""><?php echo SHONiR_Post_Fnc('meta_keyword_'.$language['language_id']) ?></textarea>
          </div>
          <?php }?>
