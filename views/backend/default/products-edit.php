...
<input type="hidden" name="files_sort_order" id="files_sort_order" value="<?php echo $SHONiR_Main['files_sort_order'];?>">
 ...
 <div class="card shadow mb-4"> 
          ...
          <?php if($SHONiR_All_Brands ){
          foreach($SHONiR_All_Brands as $Brand){  ?>
  <option value="<?php echo $Brand['brand_id']?>" <?php echo ($Brand['brand_id'] == $SHONiR_Main['brand_id'])?'selected="selected" selected':''; ?> ><?php echo $Brand['name']?></option>
  <?php }}?>
</select>
          </div>
...
<div class="mb-3">
          ...
          <textarea type="text" class="form-control" id="meta_keyword_<?php echo $language['language_id']?>" name="meta_keyword_<?php echo $language['language_id']?>" placeholder="Page, Products, sub Page, sub Products" required=""><?php echo $SHONiR_Main['meta_keyword_'.$language['language_id']] ?></textarea>
          </div>
          <?php }?>
          ...
          <input type="text" class="form-control" id="video_link" name="video_link" placeholder="https://www.youtube.com/watch?v=Ex3nRGX9Fu8"  value="<?php echo $SHONiR_Main['video_link'] ?>">
          </div>
          ...
          <input type="text" class="form-control" id="model" name="model" placeholder="0" required="" value="<?php echo $SHONiR_Main['model'] ?>">
          </div>

          <div class="mb-3">
          <label for="cost_price">Cost Price</label>
          <input type="text" class="form-control" id="cost_price" name="cost_price" placeholder="0" required="" value="<?php echo $SHONiR_Main['cost_price'] ?>">
          </div>

          <div class="mb-3">
          <label for="selling_price">Selling Price</label>
          <input type="text" class="form-control" id="selling_price" name="selling_price" placeholder="0" value="<?php echo $SHONiR_Main['selling_price'] ?>">
          </div>


          <div class="mb-3">
          <!--label for="express_delivery" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">Express Delivery <input type="checkbox" id="express_delivery" name="express_delivery" value="1" class="badgebox" <?php echo ($SHONiR_Main['express_delivery']==1)?'checked="checked" checked':''; ?>><span class="badge">&check;</span></label>
          <label for="standard_delivery" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">Standard Delivery <input type="checkbox" id="standard_delivery" name="standard_delivery" value="1" class="badgebox" <?php echo ($SHONiR_Main['standard_delivery']==1)?'checked="checked" checked':''; ?>><span class="badge">&check;</span></label-->
          ...
          <!--label for="locked" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">Locked <input type="checkbox" id="locked" name="locked" value="1" class="badgebox"  <?php echo ($SHONiR_Main['locked']==1)?'checked="checked" checked':''; ?>><span class="badge">&check;</span></label-->
...
$SHONiR_additional_options = $SHONiR_Main['options'];
...
var option_id = (typeof SHONiR_Array['option_id'] === "undefined") ? "" : SHONiR_Array['option_id'];
...
if(additional_option == 'radio' || additional_option == 'checkbox' || additional_option == 'select'){
  ...
  SHONiR_Return = ' <div class="card shadow mb-4" id="additional-option' + SHONiR_Num + '">' + 
            ...
            ' <div class="row">' +
              ...
              '<input type="hidden" name="additional_option[' + SHONiR_Num + '][option_type]" id="additional_option[' + SHONiR_Num + '][option_type]" value="'+additional_option+'"><input type="hidden" name="additional_option[' + SHONiR_Num + '][option_id]" id="additional_option[' + SHONiR_Num + '][option_id]" value="' + option_id + '"></div>' +
 ...
 SHONiR_Return = ' <div class="card shadow mb-4" id="additional-option' + SHONiR_Num + '">' + 
            ...
            ' <div class="row">' +
              ...
              '<input type="hidden" name="additional_option[' + SHONiR_Num + '][option_type]" id="additional_option[' + SHONiR_Num + '][option_type]" value="text"><input type="hidden" name="additional_option[' + SHONiR_Num + '][option_id]" id="additional_option[' + SHONiR_Num + '][option_id]" value="' + option_id + '"></div>' +
              '<div class="col-md-6 col-sm-6 col-xs-6 text-right"><button type="button" onclick="p(\'#additional-option' + SHONiR_Num + '\').remove();" data-toggle="tooltip" rel="tooltip" title="Remove" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></div>'+
            '</div>'+
            '</div>'+
            '<div class="card-body">'+
  ...
  SHONiR_Return = ' <div class="card shadow mb-4" id="additional-option' + SHONiR_Num + '">' + 
            ...
            ' <div class="row">' +
              ...
              '<input type="hidden" name="additional_option[' + SHONiR_Num + '][option_type]" id="additional_option[' + SHONiR_Num + '][option_type]" value="textarea"><input type="hidden" name="additional_option[' + SHONiR_Num + '][option_id]" id="additional_option[' + SHONiR_Num + '][option_id]" value="' + option_id + '"></div>' +
              '<div class="col-md-6 col-sm-6 col-xs-6 text-right"><button type="button" onclick="p(\'#additional-option' + SHONiR_Num + '\').remove();" data-toggle="tooltip" rel="tooltip" title="Remove" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></div>'+
            '</div>'+
            '</div>'+
            '<div class="card-body">'+
  ...
  SHONiR_Return = ' <div class="card shadow mb-4" id="additional-option' + SHONiR_Num + '">' + 
            ...
            ' <div class="row">' +
              ...
              '<input type="hidden" name="additional_option[' + SHONiR_Num + '][option_type]" id="additional_option[' + SHONiR_Num + '][option_type]" value="file"><input type="hidden" name="additional_option[' + SHONiR_Num + '][option_id]" id="additional_option[' + SHONiR_Num + '][option_id]" value="' + option_id + '"></div>' +
              '<div class="col-md-6 col-sm-6 col-xs-6 text-right"><button type="button" onclick="p(\'#additional-option' + SHONiR_Num + '\').remove();" data-toggle="tooltip" rel="tooltip" title="Remove" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></div>'+
            '</div>'+
            '</div>'+
            '<div class="card-body">'+
...
var value_id = (typeof SHONiR_Array['value_id'] === "undefined") ? "" : SHONiR_Array['value_id'];
var option_id = (typeof SHONiR_Array['option_id'] === "undefined") ? "" : SHONiR_Array['option_id'];
var sort_order = (typeof SHONiR_Array['sort_order'] === "undefined") ? "" : SHONiR_Array['sort_order'];
...
var image = (typeof SHONiR_Array['image'] === "undefined") ? "" : SHONiR_Array['image'];

alert(value_id+' - '+option_id);

	  html = '<tr id="option-value-row' + SHONiR_Num_Value + '">';
    html += '  <td class="text-left"><input type="hidden" name="additional_option[' + SHONiR_Num + '][option_value][' + SHONiR_Num_Value + '][value_id]" id="additional_option[' + SHONiR_Num + '][option_value][' + SHONiR_Num_Value + '][value_id]" value="' + value_id + '">';
    <?php  foreach($SHONiR_All_Languages as $language){ ?>
    ...
    html += '  <td class="text-right"><input type="file" id="additional_option' + SHONiR_Num + 'option_value' + SHONiR_Num_Value + 'file" name="additional_option' + SHONiR_Num + 'option_value' + SHONiR_Num_Value + 'file" accept="image/*" style="display:none" /><div class="single-image-preview-zone" id="additional_option' + SHONiR_Num + 'option_value' + SHONiR_Num_Value + '" name="additional_option[' + SHONiR_Num + '][option_value][' + SHONiR_Num_Value + ']" ><img src="<?php echo SHONiR_BASE.'media/uploads/' ?>' + image + '"><div class="image-upload" onclick="SHONiR_Single_Image_Select_Fnc(\'additional_option' + SHONiR_Num + 'option_value' + SHONiR_Num_Value + '\', true)"><i class="fas fa-upload"></i></div><div class="image-zoom"><a data-fancybox="additional_option' + SHONiR_Num + 'option_value' + SHONiR_Num_Value + '" href="<?php echo SHONiR_BASE.'media/uploads/' ?>' + image + '" data-no="additional_option' + SHONiR_Num + 'option_value' + SHONiR_Num_Value + '"><i class="fas fa-eye fa-lg text-white-50"></i></a></div></td>';
    }
