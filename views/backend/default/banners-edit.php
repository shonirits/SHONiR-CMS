<?php $SHONiR_All_Languages = $SHONiR_Main['SHONiR_Languages']; ?><!doctype html>
<html lang="en">
  <head>
...
<input type="hidden" name="files_sort_order" id="files_sort_order" value="<?php echo $SHONiR_Main['files_sort_order'];?>">
 ...
 <div class="card shadow mb-4"> 
          ...
          <input type="text" class="form-control" id="parent_id" name="parent_id" placeholder="product_6426"  value="<?php echo $SHONiR_Main['parent_id'] ?>">
          </div>

          <div class="mb-3"> 
          <label for="link">Link</label>
          <input type="text" class="form-control" id="link" name="link" placeholder="https://www.shonir.com/"  value="<?php echo $SHONiR_Main['link'] ?>">
          </div>
          ...
          <input type="text" class="form-control" id="slug_<?php echo $language['language_id']?>" name="slug_<?php echo $language['language_id']?>" placeholder="Banner-slug" required="" value="<?php echo $SHONiR_Main['slug_'.$language['language_id']] ?>">
          </div>
          ...
          <input type="text" class="form-control" id="name_<?php echo $language['language_id']?>" name="name_<?php echo $language['language_id']?>" placeholder="Banner Name" required="" value="<?php echo $SHONiR_Main['name_'.$language['language_id']] ?>">
          </div>
...
<div class="mb-3">
          ...
          <textarea type="text" class="form-control" id="description_<?php echo $language['language_id']?>" name="description_<?php echo $language['language_id']?>" placeholder="this is a main Banner description." ><?php echo $SHONiR_Main['description_'.$language['language_id']] ?></textarea>
          </div>
<?php }?>
               ...
               foreach($SHONiR_All_Languages as $language)
{
          ...
          <textarea type="text" class="form-control" id="meta_description_<?php echo $language['language_id']?>" name="meta_description_<?php echo $language['language_id']?>" placeholder="this is a main Banner description for meta tag." required=""><?php echo $SHONiR_Main['meta_description_'.$language['language_id']] ?></textarea>
          </div>
...
<div class="mb-3">
          ...
          <textarea type="text" class="form-control" id="meta_keyword_<?php echo $language['language_id']?>" name="meta_keyword_<?php echo $language['language_id']?>" placeholder="Banner, Banners, sub Banner, sub Banners" required=""><?php echo $SHONiR_Main['meta_keyword_'.$language['language_id']] ?></textarea>
          </div>
          <?php }?>
