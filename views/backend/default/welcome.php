...
<div class="copy-text">Created with <i class="fa fa-heart"></i> by <b><a href="http://www.shonir.com">SHONiR</a></b></div>
    ...
    <div class="carousel-item active">
      <img class="d-block img-fluid" src="media/backend/default/web-promotion.jpg" alt="">
      <div class="carousel-caption d-none d-md-block">
        
  </div>
    </div>
    <div class="carousel-item">
      <img class="d-block img-fluid" src="media/images/backend/default/get-email.jpg" alt="">
      <div class="carousel-caption d-none d-md-block">
        
    </div>
    </div>
    <div class="carousel-item">
      <img class="d-block img-fluid" src="media/images/backend/default/web-packages.jpg" alt="">
      <div class="carousel-caption d-none d-md-block">
