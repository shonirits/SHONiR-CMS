...
<?php require_once('common/top.php');?>
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <a href="<?php echo SHONiR_APANEL.'Categories/Add'; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-lg text-white-50"></i> &nbsp; Add Category</a>
        </div>
...
?>
            ...
            {?>
                    <tr>
                      ...
                      <td> <a href="<?php echo SHONiR_APANEL.'Categories/Edit?category_id='.$Category_value['category_id']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i class="fas fa-edit fa-lg text-white-50"></i></a> <a href="javascript:SHONiR_Confirm_Fnc('Delete Category', 'Are you sure to delete this category?', '<?php echo SHONiR_APANEL.'Categories/Delete?category_id='.$Category_value['category_id']; ?>')" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i class="fas fa-trash fa-lg text-white-50"></i></a></td>
                    </tr>
<?php } ?>
                  </tbody>
                </table>
